...
from shop.views import ProductViewSet, OrderViewSet, ReviewViewSet, AdminProductViewSet, UserProductViewSet, CreatePayPalPayment, ExecutePayPalPayment, RegisterView, LoginView
